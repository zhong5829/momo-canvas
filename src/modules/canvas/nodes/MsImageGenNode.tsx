/**
 * ModelScope 生图 — 精简节点：画布上只留结果图；
 * 提示词 / 模型 / LoRA / 尺寸等全部在选中后的底部面板里编辑。
 */
...
export const MsImageGenNode = memo(function MsImageGenNode({ id, data, selected }: NodeProps) {
  const d = data as MsImageGenData;
